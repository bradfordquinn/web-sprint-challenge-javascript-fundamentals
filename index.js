...
/* Global variables like 'external' are within the scope of the entire window. Scope determines the 'field of vision' for the many functions that may make up a program.
A function within a fucntion is known as a closure, and a closure has access to the scope of the parent function, as well as those variables that are global. */
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(data){
    ...
    console.log(`THIS =====> `,lowCaseAnimalNames)
  ...
  */
  function lowPopulationAnimals(data){
    ...
    console.log(`THAT =====>`, lowPopulationAnimals);
  ...
  */
  ...
  function USApop(data){
    const totalPopulation = data.reduce(function(v, i){
      return v + i.population;
    },0);
